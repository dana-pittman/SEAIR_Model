...
Pa=OP(k1,1);
   ...
   pars=[1.2, 0.2, 0.5, 0.83, 208, 5, Pa, 0.5, 0.2, 60, 0.00612];
...
function ESS=error_sum_of_squares5(input_pars)
  ...
  Pm = 0.00612;   % probability of transmission members
  kappaH = 1/2;  % latent period
  gammaH = 1/5;  % human recovery rate
  Cm = 60;       % contact minutes member

   Pa=input_pars(1); % prob of tranmission attendees
